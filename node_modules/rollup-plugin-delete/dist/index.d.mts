import { Options as Options$1 } from "del";
import { AsyncPluginHooks, Plugin } from "rollup";
...
declare function del(options?: Options): Plugin;
export { Options, del as default };